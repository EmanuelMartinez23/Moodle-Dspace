        ...
        (function(){
            ...
            async function loadEPUB() {
                try {
                    ...
                    status.textContent = 'Descargando EPUB...';

                    // Descargar el EPUB como Blob y crear un Object URL para evitar problemas de extensión/CORS
                    const epubResp = await fetch(data.url);
                    if (!epubResp.ok) {
